import { ParsedMessage, ParsedMessageCommand, ParsedMessageTags } from "./parseChatMessage.types";
...
function parseParameters(rawParametersComponent: string, command: ParsedMessageCommand) {
  let idx = 0
