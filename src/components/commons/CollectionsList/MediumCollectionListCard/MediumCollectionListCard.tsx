...
import { MediumCollectionListCardProps } from "./MediumCollectionListCard.types"
...
const MediumCollectionListCard = ({ collection, onPress, title, ...props }: MediumCollectionListCardProps) => {
  ...
  return (
    <Pressable marginRight="sToM" {...{ onPress }} {...props}>
      <Box
        width={ELEMENT_WIDTH}
        marginTop="sToM"
...
export default MediumCollectionListCard